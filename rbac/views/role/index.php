                    ...
                    <td>
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="javascript:;" onclick="dell('<?= $role->name ?>')"><i class="fa fa-trash-o"></i>删除</a>
                                </li>
...
<div style="display: none">
    <form class="validform" action="<?= Url::to(['/admin/user/role/dell']) ?>" method="post">
        <input type="hidden" name="<?= Yii::$app->request->csrfParam ?>" value="<?= Yii::$app->request->csrfToken ?>">
        <input id="role_name" name="name">
    </form>
</div>